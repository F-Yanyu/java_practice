package org.example.practice.Thread;

public class DeadlyEmbracePractice {
...
class Thread1 extends Thread {
    ...
    public void run() {
        ...
        synchronized (DeadlyEmbracePractice.LOCK_A) {
            System.out.println("Thread-1: lock A got.");
            DeadlyEmbracePractice.sleep1s();
            System.out.println("Thread-1: try get lock B...");
            synchronized (DeadlyEmbracePractice.LOCK_B) {
